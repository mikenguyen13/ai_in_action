...
### 8.1 A From-Scratch KV-Cache, Executed on CPU
...
### 8.2 Grouped-Query and Multi-Query Attention, Executed on CPU
...
### 8.3 FlashAttention (requires GPU)
...
### 8.4 Paged Attention with vLLM (requires GPU)
...
### 8.5 Sliding-Window Attention on GPU
...
### 8.6 Running it on a GPU (executed)
