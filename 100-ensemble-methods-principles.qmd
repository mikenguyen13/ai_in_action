...
A useful heuristic for classification is the ambiguity decomposition, which states that the ensemble error equals the average member error minus the ensemble ambiguity, a nonnegative measure of disagreement. Because ambiguity is subtracted, the ensemble can never be worse than the average member, and it improves precisely to the extent that members disagree while remaining individually accurate.
...
### 4.2 Random Forests and Out of Bag Estimates
...
### 5.3 Why Boosting Can Overfit, and Often Does Not
...
4. Friedman, J. H. (2001). Greedy Function Approximation: A Gradient Boosting Machine. Annals of Statistics, 29(5), 1189-1232. https://projecteuclid.org/journals/annals-of-statistics/volume-29/issue-5/Greedy-function-approximation-A-gradient-boosting-machine/10.1214/aos/1013203451.full
5. Wolpert, D. H. (1992). Stacked Generalization. Neural Networks, 5(2), 241-259. https://www.sciencedirect.com/science/article/abs/pii/S0893608005800231
6. Ueda, N., & Nakano, R. (1996). Generalization Error of Ensemble Estimators. Proceedings of the International Conference on Neural Networks. https://ieeexplore.ieee.org/document/548872
7. Krogh, A., & Vedelsby, J. (1995). Neural Network Ensembles, Cross Validation, and Active Learning. Advances in Neural Information Processing Systems, 7. https://proceedings.neurips.cc/paper/1994/hash/b8c37e33defde51cf91e1e03e51657da-Abstract.html
8. Brown, G., Wyatt, J., Harris, R., & Yao, X. (2005). Diversity Creation Methods: A Survey and Categorisation. Information Fusion, 6(1), 5-20. https://www.sciencedirect.com/science/article/abs/pii/S1566253504000375
9. Chen, T., & Guestrin, C. (2016). XGBoost: A Scalable Tree Boosting System. Proceedings of KDD 2016. https://dl.acm.org/doi/10.1145/2939672.2939785
10. Dietterich, T. G. (2000). Ensemble Methods in Machine Learning. Multiple Classifier Systems, 1-15. https://link.springer.com/chapter/10.1007/3-540-45014-9_1
