...
+---------------------------------------------------------------+
|  8. APPLICATION LAYER                                         |
|     chatbots, copilots, RAG apps, agents, recommenders       |
+---------------------------------------------------------------+
|  7. ORCHESTRATION & MLOPS                                     |
|     Kubernetes, Ray, Airflow, MLflow, Kubeflow, W&B          |
+---------------------------------------------------------------+
|  6. MODEL HUBS & SERVING                                      |
|     Hugging Face Hub, vLLM, TGI, Triton, TorchServe, KServe  |
+---------------------------------------------------------------+
|  5. DATA & PIPELINE TOOLING                                   |
|     Parquet, Arrow, Spark, Ray Data, DALI, tf.data, Dask     |
+---------------------------------------------------------------+
|  4. DEEP LEARNING FRAMEWORKS                                  |
|     PyTorch, JAX, TensorFlow, Keras                          |
+---------------------------------------------------------------+
|  3. NUMERICAL & TENSOR LIBRARIES                             |
|     cuBLAS, cuDNN, NCCL, MKL, oneDNN, BLAS/LAPACK, NumPy     |
+---------------------------------------------------------------+
|  2. SYSTEMS & DRIVERS                                         |
|     CUDA, ROCm, oneAPI, drivers, compilers (NVCC, XLA, LLVM) |
+---------------------------------------------------------------+
|  1. HARDWARE (ACCELERATORS)                                  |
|     GPUs, TPUs, CPUs, NPUs, interconnect (NVLink, InfiniBand)|
+---------------------------------------------------------------+
```
